$(document).ready(function() {
    ...
    $("#submit").click(function() {
        ...
        if (teamTextValid == false) {
            ...
            window.location.replace(window.location.href.split("/")[0] + "main-quiz.html?t1=" + $("#teamText1").val() + "&t2=" + $("#teamText2").val() + "&t3=" + $("#teamText3").val() + "&t4=" + $("#teamText4").val() + "&t5=" + $("#teamText5").val() + "&t6=" + $("#teamText6").val() + "&correct=&questions=");
        };
    });
});